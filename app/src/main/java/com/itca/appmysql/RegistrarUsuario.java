...
public class RegistrarUsuario extends AppCompatActivity {
    ...
    private void guardarUser(final Context context, final int id_user, final String nombreUser,
        ...
        String url = "https://eliassantossis11b.000webhostapp.com/Services/guardar_usuario.php";
        ...
        StringRequest request = new StringRequest(Request.Method.POST,url, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("nombre_usuario", nombreUser);
                map.put("apellidos_usuario", apellUser);
                map.put("correo", emailUser);
                map.put("usuario", usuario);
                map.put("clave", claveU);
                map.put("tipo_usuario", String.valueOf(tipo));
                map.put("estado_usuario", String.valueOf(estado));
